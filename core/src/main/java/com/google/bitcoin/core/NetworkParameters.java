...
public abstract class NetworkParameters implements Serializable {
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            genesisBlock.setMerkleRoot(new Sha256Hash("d57900601060be7641aea3c956c8b4c5cdeabff023228f1ca06ec0749766046b"));
        } catch (Exception e) {
            // Cannot happen.
    ...
    private static Block createGenesis1(NetworkParameters n) {
        ...
        try {
            ...
            Script.writeBytes(scriptPubKeyBytes, Hex.decode
                    ("0xd57900601060be7641aea3c956c8b4c5cdeabff023228f1ca06ec0749766046b"));
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
